<x-tutor-layout>
    ...
    <div class="max-w-4xl">
        <form action="{{ route('tutor.reports.store') }}" method="POST" id="reportForm"
            ...
            <!-- Progress Summary -->
            <div class="mb-6">
                <label for="progress_summary" class="block text-sm font-medium text-gray-900 dark:text-white mb-2">
                    Progress Summary <span class="text-red-500">*</span>
                </label>
                <textarea id="progress_summary" name="progress_summary" rows="4" required
                    class="w-full px-4 py-3 bg-white/50 dark:bg-gray-800/50 border border-gray-300 dark:border-gray-600 rounded-xl text-gray-900 dark:text-white focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                    placeholder="Overall summary of student progress this month...">{{ old('progress_summary') }}</textarea>
            ...
            <!-- Strengths -->
            <div class="mb-6">
                <label for="strengths" class="block text-sm font-medium text-gray-900 dark:text-white mb-2">
                    Strengths <span class="text-red-500">*</span>
                </label>
                <textarea id="strengths" name="strengths" rows="4" required
                    class="w-full px-4 py-3 bg-white/50 dark:bg-gray-800/50 border border-gray-300 dark:border-gray-600 rounded-xl text-gray-900 dark:text-white focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                    placeholder="Areas where the student excels...">{{ old('strengths') }}</textarea>
                @error('strengths')
                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                @enderror
            </div>
            ...
            <!-- Weaknesses -->
            <div class="mb-6">
                <label for="weaknesses" class="block text-sm font-medium text-gray-900 dark:text-white mb-2">
                    Areas for Improvement <span class="text-red-500">*</span>
                </label>
                <textarea id="weaknesses" name="weaknesses" rows="4" required
                    class="w-full px-4 py-3 bg-white/50 dark:bg-gray-800/50 border border-gray-300 dark:border-gray-600 rounded-xl text-gray-900 dark:text-white focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                    placeholder="Areas where the student needs improvement...">{{ old('weaknesses') }}</textarea>
                @error('weaknesses')
                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                @enderror
            </div>
            ...
            <!-- Next Steps -->
            <div class="mb-6">
                <label for="next_steps" class="block text-sm font-medium text-gray-900 dark:text-white mb-2">
                    Next Steps / Recommendations <span class="text-red-500">*</span>
                </label>
                <textarea id="next_steps" name="next_steps" rows="4" required
                    class="w-full px-4 py-3 bg-white/50 dark:bg-gray-800/50 border border-gray-300 dark:border-gray-600 rounded-xl text-gray-900 dark:text-white focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                    placeholder="Recommended next steps for continued growth...">{{ old('next_steps') }}</textarea>
                @error('next_steps')
                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    <label for="attendance_score" class="block text-sm font-medium text-gray-900 dark:text-white mb-2">
                        Attendance Score (0-100) <span class="text-red-500">*</span>
                    </label>
                    <input type="number" id="attendance_score" name="attendance_score" value="{{ old('attendance_score', 100) }}" min="0" max="100" required
                        class="w-full px-4 py-3 bg-white/50 dark:bg-gray-800/50 border border-gray-300 dark:border-gray-600 rounded-xl text-gray-900 dark:text-white focus:ring-2 focus:ring-purple-500 focus:border-transparent">
