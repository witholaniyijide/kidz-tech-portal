<x-tutor-layout>
    ...
    @if($reports->isEmpty())
        <div class="bg-white/20 dark:bg-gray-900/30 backdrop-blur-xl border border-white/10 rounded-2xl p-12 text-center shadow-lg">
            ...
            <p class="text-gray-600 dark:text-gray-400 mb-6">Create your first student report to get started</p>
            <a href="{{ route('tutor.reports.create') }}"
                    ...
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            <div class="flex items-center space-x-3 mb-2">
                                <a href="{{ route('tutor.reports.show', $report) }}" class="text-xl font-semibold text-gray-900 dark:text-white hover:text-purple-600 dark:hover:text-purple-400">
                                    {{ $report->title }}
                                </a>
                            ...
                            @if($report->summary)
                                <p class="mt-2 text-sm text-gray-700 dark:text-gray-300 line-clamp-2">{{ $report->summary }}</p>
                            @endif
                        </div>
