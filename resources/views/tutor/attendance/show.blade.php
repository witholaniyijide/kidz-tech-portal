        ...
        <div class="lg:col-span-2 glass-card rounded-2xl shadow-lg overflow-hidden">
            ...
            <div class="p-6 space-y-6">
                ...
                @if($attendance->courses_covered && count($attendance->courses_covered) > 0)
                    <div>
                        <label class="block text-sm font-medium text-slate-500 dark:text-slate-400 mb-2">Course(s) Covered</label>
                        <div class="flex flex-wrap gap-2">
                            @foreach($attendance->courses_covered as $course)
                                <span class="inline-flex items-center px-3 py-1.5 bg-[#7978E9]/10 dark:bg-[#7978E9]/20 text-[#4B49AC] dark:text-[#98BDFF] text-sm font-medium rounded-lg">
                ...
                @if($attendance->topic)
                    <div>
                        <label class="block text-sm font-medium text-slate-500 dark:text-slate-400 mb-1">Topic/Lesson Details</label>
