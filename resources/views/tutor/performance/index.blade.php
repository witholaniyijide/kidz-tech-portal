...
<div class="space-y-6">
    ...
    <div class="flex flex-wrap items-center justify-between gap-4">
        ...
        <a href="{{ route('tutor.performance.student-summary') }}" class="px-4 py-2 bg-gradient-to-r from-[#4B49AC] to-[#7978E9] text-white rounded-xl font-medium hover:shadow-lg transition-all flex items-center gap-2">
    ...
    <div class="glass-card rounded-2xl p-4">
        <form method="GET" action="{{ route('tutor.performance.index') }}" class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
