    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <div class="flex space-x-3">
                <a href="{{ route('director.tutors.edit', $tutor) }}" class="inline-flex items-center px-4 py-2 bg-yellow-500/80 hover:bg-yellow-500 text-white font-semibold rounded-lg transition-all">
