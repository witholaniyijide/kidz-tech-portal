<x-app-layout>
    ...
    <x-slot name="title">{{ __('Director - Add Tutor') }}</x-slot>
    ...
    <div class="min-h-screen bg-gradient-to-br from-[#423A8E]/5 via-[#00CCCD]/5 to-blue-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 py-4 sm:py-8 relative overflow-hidden">
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6 sm:mb-8">
                <div>
                    <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">Add New Tutor</h1>
                    <p class="text-gray-600 dark:text-gray-400 mt-1 text-sm sm:text-base">Fill in the tutor information below</p>
                </div>
                <a href="{{ route('director.tutors.index') }}" class="inline-flex items-center justify-center px-4 py-2 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors text-sm sm:text-base">
            ...
            <form action="{{ route('director.tutors.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="p-4 sm:p-6">
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                            ...
                            <div class="sm:col-span-2 lg:col-span-3">
                                ...
                                <textarea name="bio" rows="3" class="w-full px-3 sm:px-4 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg focus:ring-2 focus:ring-[#423A8E] text-sm sm:text-base">{{ old('bio') }}</textarea>
                            </div>
                            {{-- Profile Photo --}}
                            <div class="sm:col-span-2 lg:col-span-3">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="emergency_contact_name" value="{{ old('emergency_contact_name') }}"
                                       class="w-full px-3 sm:px-4 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg focus:ring-2 focus:ring-orange-500 text-sm sm:text-base">
                            </div>
                            {{-- Relationship --}}
                            <div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="bank_name" value="{{ old('bank_name') }}"
                                       class="w-full px-3 sm:px-4 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg focus:ring-2 focus:ring-emerald-500 text-sm sm:text-base">
                            </div>
                            {{-- Account Number --}}
                            <div>
                ...
                <div class="flex flex-col sm:flex-row justify-end gap-3 sm:gap-4">
                    <a href="{{ route('director.tutors.index') }}" class="px-6 py-3 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-xl hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors font-medium text-center text-sm sm:text-base">
                        Cancel
                    </a>
