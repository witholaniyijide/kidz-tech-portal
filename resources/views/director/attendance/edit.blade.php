                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <textarea name="topics_covered" rows="3" placeholder="What was covered in the class..."
                                      class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-[#4F46E5] focus:ring-[#4F46E5]">{{ old('topics_covered', $attendance->topics_covered) }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea name="notes" rows="2" placeholder="Additional notes..."
                                      class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-[#4F46E5] focus:ring-[#4F46E5]">{{ old('notes', $attendance->notes) }}</textarea>
                            @error('notes')
                                <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
                        </div>
