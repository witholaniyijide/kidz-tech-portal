...
<head>
    ...
    <title>Welcome to Kidz Tech Coding Club</title>
</head>
                ...
                <table role="presentation" style="width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <p style="margin: 0 0 20px 0; font-size: 16px; color: #1f2937; line-height: 1.6;">
                                Welcome to the Kidz Tech Coding Club team! Your tutor account has been successfully created. You can now access the Tutor Portal to manage your classes, submit attendance, and create student progress reports.
                            </p>
