...
<head>
    ...
    <title>Report Approved by Director</title>
</head>
                ...
                <table role="presentation" style="width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                    ...
                    <tr>
                        <td style="background: linear-gradient(135deg, #059669 0%, #10b981 100%); padding: 40px 30px; text-align: center;">
                            ...
                            <p style="margin: 10px 0 0 0; color: rgba(255, 255, 255, 0.9); font-size: 16px;">
                                Director Has Approved This Report
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <p style="margin: 0 0 20px 0; font-size: 16px; color: #1f2937; line-height: 1.6;">
                                Excellent work! The progress report for <strong>{{ $student->fullName() }}</strong> for the month of <strong>{{ date('F Y', strtotime($report->month . '-01')) }}</strong> has received <strong>final approval from the Director</strong>.
                            </p>

                            <!-- Report Summary Card -->
                            <table role="presentation" style="width: 100%; border-collapse: collapse; margin: 30px 0; background-color: #f0fdf4; border-left: 4px solid #10b981; border-radius: 8px;">
                                <tr>
                                    <td style="padding: 20px;">
                                        <h2 style="margin: 0 0 15px 0; font-size: 18px; color: #059669;">
                                            Report Summary
                                        </h2>
                                        <table role="presentation" style="width: 100%; border-collapse: collapse;">
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding: 8px 0; font-size: 14px; color: #059669; font-weight: bold;">
                                                    ✅ Final Approval - Published to Parent Portal
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                            ...
                            <p style="margin: 30px 0 20px 0; font-size: 16px; color: #1f2937; line-height: 1.6;">
                                The complete progress report is attached to this email as a PDF, and has been published to the parent portal for {{ $student->first_name }}'s family to view.
                            </p>
                            ...
                            <table role="presentation" style="margin: 30px 0;">
                                <tr>
                                    <td style="text-align: center;">
                                        <a href="{{ url('/tutor/reports/' . $report->id) }}" style="display: inline-block; background: linear-gradient(135deg, #059669 0%, #10b981 100%); color: #ffffff; text-decoration: none; padding: 14px 32px; border-radius: 8px; font-size: 16px; font-weight: bold; box-shadow: 0 4px 6px rgba(5, 150, 105, 0.3);">
                                            📄 View Report Online
                                        </a>
                                    </td>
                                </tr>
                            ...
                            <p style="margin: 30px 0 0 0; font-size: 14px; color: #6b7280; line-height: 1.6;">
                                Thank you for your dedication and excellent reporting. Your detailed progress updates help our students and their families track growth and celebrate achievements!
                            </p>
