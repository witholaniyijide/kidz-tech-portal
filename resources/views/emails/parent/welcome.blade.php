                ...
                <table role="presentation" style="width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <p style="margin: 0 0 20px 0; font-size: 16px; color: #1f2937; line-height: 1.6;">
                                An account has been created and linked with your child <strong>{{ $student->first_name }} {{ $student->last_name }}</strong>. This account will give you personalized access to your child's monthly progress report and tracking how {{ $student->gender === 'female' ? 'she' : 'he' }} is developing in their coding journey.
                            </p>
                            ...
                            <p style="margin: 20px 0 0 0; font-size: 14px; color: #6b7280; line-height: 1.6;">
                                Through the Parent Portal, you'll be able to:
                            </p>
