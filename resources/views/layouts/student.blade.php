...
<head>
    ...
    <script>
        // Dark mode initialization - using 'darkMode' key for consistency across all portals
        ...
        <aside class="hidden lg:flex lg:flex-shrink-0 w-64" x-data="{ open: true }">
            <div class="flex flex-col w-64 border-r border-white/10 bg-white/30 dark:bg-gray-900/30 backdrop-blur-xl">
                ...
                <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
                    ...
                    <a href="{{ route('student.roadmap.full') }}"
                       class="flex items-center px-4 py-3 text-sm font-medium rounded-xl transition-all duration-200 {{ request()->routeIs('student.roadmap.*') ? 'bg-sky-500 text-white shadow-lg' : 'text-gray-700 dark:text-gray-300 hover:bg-sky-100 dark:hover:bg-sky-900/30' }}">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('student.attendance.index') }}"
                       class="flex items-center px-4 py-3 text-sm font-medium rounded-xl transition-all duration-200 {{ request()->routeIs('student.attendance.*') ? 'bg-sky-500 text-white shadow-lg' : 'text-gray-700 dark:text-gray-300 hover:bg-sky-100 dark:hover:bg-sky-900/30' }}">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <header class="lg:hidden bg-gradient-student shadow-lg" x-data="{ mobileMenuOpen: false }">
                ...
                <div x-show="mobileMenuOpen"
                    ...
                    <nav class="px-4 py-4 space-y-2">
                        ...
                        <a href="{{ route('student.roadmap.full') }}"
                           class="flex items-center px-4 py-3 text-sm font-medium rounded-xl {{ request()->routeIs('student.roadmap.*') ? 'bg-sky-500 text-white' : 'text-gray-700 dark:text-gray-300 hover:bg-sky-100 dark:hover:bg-sky-900/30' }}">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7"/>
                            </svg>
                            Roadmap
                        ...
                        <a href="{{ route('student.attendance.index') }}"
                           class="flex items-center px-4 py-3 text-sm font-medium rounded-xl {{ request()->routeIs('student.attendance.*') ? 'bg-sky-500 text-white' : 'text-gray-700 dark:text-gray-300 hover:bg-sky-100 dark:hover:bg-sky-900/30' }}">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"/>
                            </svg>
                            Attendance
