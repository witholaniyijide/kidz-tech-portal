        ...
        <div x-data="{
            ...
            init() {
                ...
                window.addEventListener('sidebar-toggled', () => {
                    if (!this.isMobile) {
                        this.collapsed = localStorage.getItem('directorSidebarCollapsed') === 'true';
                    }
                });
            },
            handleResize() {
                    ...
                    <div class="flex items-center justify-between h-14 md:h-16 px-4 md:px-6">
                        ...
                        <div class="flex items-center space-x-2 md:space-x-4">
                            ...
                            <div x-data="{ open: false }" class="relative">
                                ...
                                >
                                    <div class="w-8 h-8 md:w-9 md:h-9 rounded-full bg-gradient-to-br from-[#4F46E5] to-[#818CF8] flex items-center justify-center text-white font-bold text-sm shadow-lg">
                                ...
                                >
                                    ...
                                    <a href="{{ route('director.settings.index') }}" class="flex items-center gap-3 px-4 py-3 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
