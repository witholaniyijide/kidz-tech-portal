...
<head>
    ...
    <title>Add New Student - Kidz Tech Portal</title>
    ...
    <div class="py-8 px-4 sm:px-6 lg:px-8">
        <div class="max-w-6xl mx-auto">
            ...
            <div class="mb-8 flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-800 dark:text-white">Add New Student</h1>
                    <p class="text-gray-600 dark:text-gray-400 mt-1">Create a new student profile with all necessary information</p>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="coding_experience" id="coding_experience" rows="3"
                                class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all">{{ old('coding_experience') }}</textarea>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="career_interest" id="career_interest" rows="2"
                                class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all">{{ old('career_interest') }}</textarea>
                ...
                <div class="relative overflow-hidden rounded-2xl bg-white/70 dark:bg-slate-800/70 backdrop-blur-xl shadow-xl p-6 border border-white/20">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="md:col-span-2">
                            ...
                            <input type="url" name="google_classroom_link" id="google_classroom_link" value="{{ old('google_classroom_link') }}" required
                                class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="url" name="class_link" id="class_link" value="{{ old('class_link') }}"
                                class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all">
                        </div>
                        ...
                        <div>
                            ...
                            <select name="classes_per_week" id="classes_per_week"
                                class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all">
                                <option value="1" {{ old('classes_per_week', '1') == '1' ? 'selected' : '' }}>1 Class</option>
                        ...
                        <div>
                            ...
                            <input type="number" name="total_periods" id="total_periods" value="{{ old('total_periods', '0') }}"
                                class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" name="completed_periods" id="completed_periods" value="{{ old('completed_periods', '0') }}" readonly
                                class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-slate-600 bg-gray-100 dark:bg-slate-600 text-gray-900 dark:text-white cursor-not-allowed">
                ...
                <div class="relative overflow-hidden rounded-2xl bg-white/70 dark:bg-slate-800/70 backdrop-blur-xl shadow-xl p-6 border border-white/20">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="tel" name="father_phone" id="father_phone" value="{{ old('father_phone') }}"
                                class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all">
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="father_location" id="father_location" value="{{ old('father_location') }}"
                                class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all">
                        </div>
                    </div>
                </div>
                ...
                <div class="relative overflow-hidden rounded-2xl bg-white/70 dark:bg-slate-800/70 backdrop-blur-xl shadow-xl p-6 border border-white/20">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="tel" name="mother_phone" id="mother_phone" value="{{ old('mother_phone') }}"
                                class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all">
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="mother_location" id="mother_location" value="{{ old('mother_location') }}"
                                class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all">
                        </div>
                    </div>
                </div>
                ...
                <div class="flex items-center justify-between gap-4 pt-4">
                    ...
                    <div class="flex gap-4">
                        ...
                        <button type="submit" name="action" value="save_and_add"
                            class="px-8 py-4 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-300">
                            <svg class="w-5 h-5 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"/>
                            </svg>
                            Save & Add Another
    ...
    <script>
        function studentForm() {
            return {
                ...
                age: {{ old('age', 0) }},
                classSchedules: [
                    { day: '{{ old('class_schedule.0.day', '') }}', time: '{{ old('class_schedule.0.time', '') }}' }
                ],
