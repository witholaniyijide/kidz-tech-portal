    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                Progress Report: {{ $report->month }} {{ $report->year }}
            </h2>
            <a href="{{ route('parent.child.reports', $student) }}" style="display: inline-block; padding: 10px 20px; background-color: #6B7280; color: white; font-weight: bold; border-radius: 8px; text-decoration: none;">
                ← Back to Reports
            </a>
        </div>
    </x-slot>
                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6 pb-6 border-b">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-gray-900">{{ $report->created_at->format('M d, Y') }}</p>
                        </div>
                    </div>
