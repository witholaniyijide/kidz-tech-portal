<x-app-layout>
    ...
    <div class="py-8">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            @if (session('success'))
                <div class="mb-6 glass-card rounded-xl p-4 bg-green-50/90 dark:bg-green-900/20 border border-green-200 dark:border-green-800" role="alert">
            ...
            @if ($errors->any())
                <div class="mb-6 glass-card rounded-xl p-4 bg-red-50/90 dark:bg-red-900/20 border border-red-200 dark:border-red-800" role="alert">
                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('parent.settings.profile') }}">
                        ...
                        <div class="mt-6 flex justify-end">
                            <button type="submit"
                                    class="px-6 py-2.5 bg-gradient-to-r from-sky-600 to-cyan-600 hover:from-sky-700 hover:to-cyan-700 text-white font-medium rounded-lg shadow-lg hover:shadow-xl transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2">
                                Save Profile
                            </button>
                        </div>
                    </form>
            ...
            <div class="glass-card rounded-xl shadow-xl bg-white/90 dark:bg-gray-800/90 border border-white/20 dark:border-gray-700/50 mb-6 overflow-hidden">
                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('parent.settings.password') }}">
                        ...
                        <div class="mt-6 flex justify-end">
                            <button type="submit"
                                    class="px-6 py-2.5 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-medium rounded-lg shadow-lg hover:shadow-xl transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2">
                                Change Password
                            </button>
                        </div>
                    </form>
            ...
            <div class="glass-card rounded-xl shadow-xl bg-white/90 dark:bg-gray-800/90 border border-white/20 dark:border-gray-700/50 overflow-hidden">
                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('parent.settings.notifications') }}">
                            ...
                            <div class="flex items-center justify-between p-4 rounded-lg bg-gray-50 dark:bg-gray-900/50 hover:bg-gray-100 dark:hover:bg-gray-900 transition-colors">
                                ...
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox"
                                           ...
                                           class="sr-only peer"
                                           role="switch"
                                           aria-checked="{{ old('notify_email', $user->notify_email) ? 'true' : 'false' }}">
                            ...
                            <div class="flex items-center justify-between p-4 rounded-lg bg-gray-50 dark:bg-gray-900/50 hover:bg-gray-100 dark:hover:bg-gray-900 transition-colors">
                                ...
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox"
                                           ...
                                           name="notify_in_app"
                                           value="1"
                                           {{ old('notify_in_app', $user->notify_in_app) ? 'checked' : '' }}
                                           class="sr-only peer"
                                           role="switch"
                                           aria-checked="{{ old('notify_in_app', $user->notify_in_app) ? 'true' : 'false' }}">
                                    <div class="w-14 h-7 bg-gray-300 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-emerald-300 dark:peer-focus:ring-emerald-800 rounded-full peer dark:bg-gray-600 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[4px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-6 after:w-6 after:transition-all dark:border-gray-600 peer-checked:bg-emerald-600"></div>
                                </label>
                            </div>
                            ...
                            <div class="flex items-center justify-between p-4 rounded-lg bg-gray-50 dark:bg-gray-900/50 hover:bg-gray-100 dark:hover:bg-gray-900 transition-colors">
                                ...
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox"
                                           ...
                                           value="1"
                                           {{ old('notify_daily_summary', $user->notify_daily_summary) ? 'checked' : '' }}
                                           class="sr-only peer"
                                           role="switch"
                                           aria-checked="{{ old('notify_daily_summary', $user->notify_daily_summary) ? 'true' : 'false' }}">
                                    <div class="w-14 h-7 bg-gray-300 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-emerald-300 dark:peer-focus:ring-emerald-800 rounded-full peer dark:bg-gray-600 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[4px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-6 after:w-6 after:transition-all dark:border-gray-600 peer-checked:bg-emerald-600"></div>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="mt-6 flex justify-end">
                            <button type="submit"
                                    class="px-6 py-2.5 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white font-medium rounded-lg shadow-lg hover:shadow-xl transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2">
                                Save Preferences
                            </button>
                        </div>
                    </form>
