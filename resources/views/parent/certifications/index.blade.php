                        ...
                        <div class="p-5">
                            ...
                            <div>
                                <a href="{{ route('parent.certifications.download', $cert) }}"
                                   class="flex items-center justify-center space-x-2 px-4 py-2.5 bg-amber-500 text-white rounded-lg hover:bg-amber-600 transition-colors text-sm font-medium w-full">
