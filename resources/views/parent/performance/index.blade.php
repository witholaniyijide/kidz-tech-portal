<x-parent-layout>
    <x-slot name="title">{{ $selectedChild->first_name }}'s Performance</x-slot>
    <x-slot name="subtitle">Track {{ $selectedChild->first_name }}'s progress, skills, and achievements from monthly reports</x-slot>
