<x-student-layout title="{{ $notice->title }}">
    <div class="space-y-6">
        <!-- Back Button -->
        <div>
            <a href="{{ route('student.notices.index') }}" class="inline-flex items-center text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors">
        ...
        <div class="glass-card rounded-2xl overflow-hidden">
            <!-- Header -->
            <div class="p-6 {{ $notice->type === 'urgent' ? 'bg-red-50 dark:bg-red-900/20 border-b-2 border-red-500' : ($notice->type === 'warning' ? 'bg-yellow-50 dark:bg-yellow-900/20 border-b-2 border-yellow-500' : 'bg-gradient-student') }}">
