<x-manager-layout title="Notice Board">
    {{-- Header --}}
    <div class="flex flex-wrap items-center justify-between gap-4 mb-8">
        ...
        <a href="{{ route('manager.notices.create') }}" class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-[#C15F3C] to-[#DA7756] text-white font-semibold rounded-xl hover:from-[#A34E30] hover:to-[#C15F3C] transition-all shadow-lg shadow-orange-500/25">
    ...
    <div class="grid grid-cols-4 gap-4 mb-8">
        <div class="bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl border border-white/20 dark:border-gray-700/50 rounded-xl p-4 text-center shadow-sm">
            <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ $stats['total'] }}</p>
            <p class="text-xs text-gray-500 dark:text-gray-400">Total</p>
        </div>
        <div class="bg-red-50 dark:bg-red-900/20 backdrop-blur-xl border border-red-200 dark:border-red-800/30 rounded-xl p-4 text-center shadow-sm">
        ...
        <div class="bg-blue-50 dark:bg-blue-900/20 backdrop-blur-xl border border-blue-200 dark:border-blue-800/30 rounded-xl p-4 text-center shadow-sm">
        ...
        <div class="bg-amber-50 dark:bg-amber-900/20 backdrop-blur-xl border border-amber-200 dark:border-amber-800/30 rounded-xl p-4 text-center shadow-sm">
    ...
    {{-- Filter --}}
    <div class="bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl border border-white/20 dark:border-gray-700/50 rounded-xl p-4 mb-6 shadow-sm">
        <form action="{{ route('manager.notices.index') }}" method="GET" class="flex flex-wrap gap-4 items-center">
            <div class="flex-1 min-w-[150px]">
                <select name="priority" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-[#C15F3C] focus:ring-[#C15F3C] text-sm">
            ...
            <div class="flex-1 min-w-[150px]">
                <select name="status" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-[#C15F3C] focus:ring-[#C15F3C] text-sm">
                    <option value="">All Status</option>
                    <option value="published" {{ request('status') == 'published' ? 'selected' : '' }}>Published</option>
                    <option value="draft" {{ request('status') == 'draft' ? 'selected' : '' }}>Draft</option>
                </select>
            </div>
            <button type="submit" class="px-4 py-2 bg-[#C15F3C]/10 dark:bg-[#C15F3C]/20 text-[#C15F3C] dark:text-[#DA7756] font-medium rounded-lg hover:bg-[#C15F3C]/20 dark:hover:bg-[#C15F3C]/30 transition-all text-sm">
                Filter
            </button>
    ...
    <div class="bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl border border-white/20 dark:border-gray-700/50 rounded-2xl overflow-hidden shadow-sm">
        <div class="p-4 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-[#C15F3C]/10 to-[#DA7756]/10">
            <div class="flex items-center gap-2">
                <svg class="w-5 h-5 text-[#C15F3C] dark:text-[#DA7756]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="divide-y divide-gray-100 dark:divide-gray-800">
            @forelse($notices as $notice)
                <div class="p-6 hover:bg-gray-50/50 dark:hover:bg-gray-700/20 transition-colors">
                    <div class="flex gap-4">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <div class="flex items-center gap-4">
                                <a href="{{ route('manager.notices.show', $notice) }}" class="text-sm text-[#C15F3C] dark:text-[#DA7756] hover:text-[#A34E30] dark:hover:text-[#C15F3C] font-medium">
                                    Read More
                                </a>
            ...
            @empty
                <div class="p-12 text-center">
                    ...
                    <a href="{{ route('manager.notices.create') }}" class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-[#C15F3C] to-[#DA7756] text-white font-medium rounded-lg hover:from-[#A34E30] hover:to-[#C15F3C] transition-all">
