        ...
        <div class="flex items-center justify-between">
            <a href="{{ route('tutor.dashboard') }}" class="flex-shrink-0 flex items-center justify-center" x-cloak>
                ...
                <img x-data x-init="$el.remove()" src="{{ asset('images/logo_light.png') }}" alt="KidzTech Logo"
                     class="w-12 h-12 md:w-14 md:h-14 object-contain" onerror="this.style.display='none'">
            </a>
    ...
    <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
        <a href="{{ route('tutor.dashboard') }}"
           class="flex items-center px-3 py-2.5 rounded-xl transition-all duration-200 group
                  {{ request()->routeIs('tutor.dashboard') ? 'bg-gradient-to-r from-[#4B49AC] to-[#7978E9] text-white shadow-lg' : 'text-gray-700 dark:text-slate-300 hover:bg-gray-100 dark:hover:bg-slate-700/50' }}"
        ...
        <a href="{{ route('tutor.students.index') }}"
           class="flex items-center px-3 py-2.5 rounded-xl transition-all duration-200 group
                  {{ request()->routeIs('tutor.students.*') ? 'bg-gradient-to-r from-[#4B49AC] to-[#7978E9] text-white shadow-lg' : 'text-gray-700 dark:text-slate-300 hover:bg-gray-100 dark:hover:bg-slate-700/50' }}"
           :title="collapsed ? 'My Students' : ''">
            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/>
            </svg>
            <span x-show="!collapsed || window.innerWidth < 768" x-transition class="ml-3 font-medium">My Students</span>
        </a>

        <a href="{{ route('tutor.attendance.index') }}"
           class="flex items-center px-3 py-2.5 rounded-xl transition-all duration-200 group
                  {{ request()->routeIs('tutor.attendance.*') ? 'bg-gradient-to-r from-[#4B49AC] to-[#7978E9] text-white shadow-lg' : 'text-gray-700 dark:text-slate-300 hover:bg-gray-100 dark:hover:bg-slate-700/50' }}"
        ...
        <a href="{{ route('tutor.availability.index') }}"
           class="flex items-center px-3 py-2.5 rounded-xl transition-all duration-200 group
                  {{ request()->routeIs('tutor.availability.*') ? 'bg-gradient-to-r from-[#4B49AC] to-[#7978E9] text-white shadow-lg' : 'text-gray-700 dark:text-slate-300 hover:bg-gray-100 dark:hover:bg-slate-700/50' }}"
           :title="collapsed ? 'Availability' : ''">
            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
            </svg>
            <span x-show="!collapsed || window.innerWidth < 768" x-transition class="ml-3 font-medium">Availability</span>
        </a>
        ...
        <a href="{{ route('tutor.monthly-schedule.index') }}"
           ...
           :title="collapsed ? 'Monthly Schedule' : ''">
            ...
            <span x-show="!collapsed || window.innerWidth < 768" x-transition class="ml-3 font-medium">Monthly Schedule</span>
        </a>
        ...
        <a href="{{ route('tutor.performance.index') }}"
           class="flex items-center px-3 py-2.5 rounded-xl transition-all duration-200 group
                  {{ request()->routeIs('tutor.performance.*') ? 'bg-gradient-to-r from-[#4B49AC] to-[#7978E9] text-white shadow-lg' : 'text-gray-700 dark:text-slate-300 hover:bg-gray-100 dark:hover:bg-slate-700/50' }}"
           :title="collapsed ? 'My Performance' : ''">
            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>
            </svg>
            <span x-show="!collapsed || window.innerWidth < 768" x-transition class="ml-3 font-medium">My Performance</span>
        </a>
        ...
        <a href="{{ route('tutor.profile.edit') }}"
           class="flex items-center px-3 py-2.5 rounded-xl transition-all duration-200 group
                  {{ request()->routeIs('tutor.profile.*') ? 'bg-gradient-to-r from-[#4B49AC] to-[#7978E9] text-white shadow-lg' : 'text-gray-700 dark:text-slate-300 hover:bg-gray-100 dark:hover:bg-slate-700/50' }}"
