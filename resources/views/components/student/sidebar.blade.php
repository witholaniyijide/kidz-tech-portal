    ...
    <div class="p-4 border-b border-gray-200 dark:border-slate-700">
        <div class="flex items-center" :class="collapsed ? 'justify-center' : 'justify-between'">
            ...
            <a href="{{ route('student.dashboard') }}" class="flex-shrink-0 flex items-center justify-center" x-cloak>
                ...
                {{-- Fallback Logo with Student Orange --}}
    ...
    <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
        ...
        <a href="{{ route('student.reports.index') }}"
           ...
           :title="collapsed ? 'My Reports' : ''">
            ...
            <span x-show="!collapsed" x-transition class="ml-3 font-medium">My Reports</span>
        </a>
        ...
        <a href="{{ route('student.attendance.index') }}"
           ...
           :title="collapsed ? 'My Attendance' : ''">
            ...
            <span x-show="!collapsed" x-transition class="ml-3 font-medium">My Attendance</span>
        </a>
        ...
        <a href="{{ route('student.schedule.index') }}"
           ...
           :title="collapsed ? 'My Schedule' : ''">
            ...
            <span x-show="!collapsed" x-transition class="ml-3 font-medium">My Schedule</span>
        </a>
        ...
        <a href="{{ route('student.profile.index') }}"
           ...
           :title="collapsed ? 'My Profile' : ''">
            ...
            <span x-show="!collapsed" x-transition class="ml-3 font-medium">My Profile</span>
        </a>
    </nav>
