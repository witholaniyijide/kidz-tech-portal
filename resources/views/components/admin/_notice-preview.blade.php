...
<div class="glass-card rounded-2xl p-6 shadow-xl" role="region" aria-label="Notice Board" style="animation-delay: 0.7s;">
    <div class="flex items-center justify-between mb-6">
        ...
        <a
            ...
            class="text-[#423A8E] dark:text-[#00CCCD] hover:text-[#423A8E] dark:hover:text-[#00CCCD] font-medium text-sm transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[#423A8E] focus-visible:ring-offset-2 rounded px-2 py-1 flex items-center"
    ...
    <div class="space-y-3 mb-6" role="list" aria-label="Recent notices">
        ...
        <article
            class="p-4 bg-white dark:bg-slate-800/50 rounded-lg border border-gray-200 dark:border-gray-700 hover:shadow-md transition-all duration-300 focus-within:ring-2 focus-within:ring-[#423A8E]"
            role="listitem"
        >
            <div class="flex items-start justify-between mb-2">
                <span class="px-3 py-1 bg-gradient-to-r from-[#423A8E] to-[#00CCCD] text-white text-xs font-semibold rounded-full">
                    {{ $notice['type'] ?? 'General' }}
                </span>
            ...
            <a
                href="{{ $notice['url'] }}"
                class="inline-flex items-center text-sm text-[#423A8E] hover:text-[#423A8E] dark:text-[#00CCCD] dark:hover:text-[#00CCCD] font-medium focus:outline-none focus-visible:ring-2 focus-visible:ring-[#423A8E] focus-visible:ring-offset-2 rounded px-1"
