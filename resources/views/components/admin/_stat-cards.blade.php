...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8" role="region" aria-label="Statistics Overview">
    ...
    <x-ui.stat-card
        ...
        gradient="from-[#423A8E] to-[#00CCCD]"
        textGradient="from-[#423A8E] to-[#00CCCD]"
        role="article"
    ...
    <x-ui.stat-card
        ...
        gradient="from-[#00CCCD] to-[#0D6EFD]"
        textGradient="from-[#00CCCD] to-[#0D6EFD]"
        role="article"
    ...
    <x-ui.stat-card
        ...
        gradient="from-[#198754] to-[#00CCCD]"
        textGradient="from-[#198754] to-[#00CCCD]"
        role="article"
    ...
    <x-ui.stat-card
        ...
        gradient="from-[#FFC107] to-[#DC3545]"
        textGradient="from-[#FFC107] to-[#DC3545]"
        role="article"
