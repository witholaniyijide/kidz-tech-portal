...
class="fixed left-0 top-0 h-screen bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 text-white flex flex-col transition-all duration-300 z-50 shadow-2xl">
    ...
    <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
        ...
        <a href="{{ route('director.activity-logs.index') }}"
           class="flex items-center px-3 py-2.5 rounded-xl transition-all duration-200 group
                  {{ request()->routeIs('director.activity-logs.*') ? 'bg-gradient-to-r from-blue-600 to-purple-600 text-white shadow-lg' : 'text-slate-300 hover:bg-slate-700/50 hover:text-white' }}"
    ...
    <div class="p-3 border-t border-slate-700/50">
        ...
        {{-- User Profile --}}
        <div class="flex items-center px-3 py-2.5 rounded-xl bg-slate-700/30" :class="collapsed ? 'justify-center' : ''">
        ...
        <form method="POST" action="{{ route('logout') }}" class="mt-2">
            @csrf
            <button type="submit"
                    class="w-full flex items-center px-3 py-2.5 rounded-xl text-red-400 hover:bg-red-500/20 hover:text-red-300 transition-all duration-200"
                    :class="collapsed ? 'justify-center' : ''"
