    ...
    <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
        ...
        <a href="{{ route('parent.children.index') }}"
           ...
           :title="collapsed ? 'My Children' : ''">
            ...
            <span x-show="!collapsed || window.innerWidth < 768" x-transition class="ml-3 font-medium">My Children</span>
        </a>
        ...
        <a href="{{ route('parent.reports.index') }}"
           ...
           :title="collapsed ? 'Progress Reports' : ''">
            ...
            <span x-show="!collapsed || window.innerWidth < 768" x-transition class="ml-3 font-medium">Progress Reports</span>
        </a>
        ...
        <a href="{{ route('parent.schedule.index') }}"
           ...
           :title="collapsed ? 'Class Schedule' : ''">
            ...
            <span x-show="!collapsed || window.innerWidth < 768" x-transition class="ml-3 font-medium">Class Schedule</span>
        </a>
        ...
        <a href="{{ route('parent.performance.index') }}"
           ...
           :title="collapsed ? 'Performance' : ''">
            ...
            <span x-show="!collapsed || window.innerWidth < 768" x-transition class="ml-3 font-medium">Performance</span>
        </a>
