<x-app-layout>
    <x-slot name="header">{{ __('Student Reports') }}</x-slot>
                ...
                <form method="GET" class="space-y-4">
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
                        ...
                        <div class="flex items-end gap-2">
                            <button type="submit" class="flex-1 sm:flex-none px-4 py-2 bg-[#423A8E] text-white rounded-lg hover:bg-[#423A8E] transition-colors">
                                Filter
                            </button>
                            @if(request()->hasAny(['student_id', 'tutor_id', 'month', 'year']))
                                <a href="{{ route('admin.reports.index') }}" class="flex-1 sm:flex-none px-4 py-2 text-center bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors">
                                    Clear
                                </a>
                            @endif
                        </div>
                                    ...
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                                        <td class="px-6 py-4">
                                            <div class="flex items-center">
                                                <div class="w-9 h-9 bg-gradient-to-br from-[#00CCCD] to-[#00CCCD] rounded-full flex items-center justify-center text-white font-bold text-xs mr-3">
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex items-center justify-center gap-2">
                                                <a href="{{ route('admin.reports.show', $report) }}" class="p-2 text-[#423A8E] hover:bg-[#423A8E]/5 dark:hover:bg-[#423A8E]/40/20 rounded-lg transition-colors" title="View Report">
