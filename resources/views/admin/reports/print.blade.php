...
<head>
    ...
    <title>Print - Progress Report - {{ $report->student->fullName() ?? 'Student' }}</title>
    <style>
        @media print {
            @page { margin: 1.5cm; }
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .section-content { padding: 8px 0; text-align: justify; line-height: 1.7; color: #222; }
        ...
        .skills-subsection { margin-bottom: 15px; }
        .skills-subtitle { font-weight: bold; color: #333; font-size: 11pt; margin-bottom: 8px; }
        ...
        .skill-tag.new { background-color: #d1fae5; color: #065f46; }
    ...
    <div class="report-info">
        <div class="info-grid">
            <div class="info-item">
                ...
                <span class="info-value">{{ $report->student->fullName() ?? ($report->student->first_name . ' ' . $report->student->last_name) }}</span>
            </div>
            <div class="info-item">
