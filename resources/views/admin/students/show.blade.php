        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="flex flex-wrap items-center justify-between gap-4 mb-8">
                ...
                <div class="flex gap-2">
                    <a href="{{ route('admin.students.edit', $student) }}" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <p class="text-gray-900 dark:text-white">{{ $student->date_of_birth?->format('M j, Y') ?? '-' }}</p>
                        </div>
                        <div>
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <p class="text-gray-900 dark:text-white">{{ ($student->classes_per_week ?? 1) * 4 }} classes</p>
                        </div>
                        <div>
