                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <p class="text-gray-900 dark:text-white">{{ $tutor->contact_person_name ?? '-' }}</p>
                        </div>
                        <div>
                            <label class="block text-xs font-medium text-gray-500 dark:text-gray-400 uppercase mb-1">Relationship</label>
                            <p class="text-gray-900 dark:text-white">{{ $tutor->contact_person_relationship ?? '-' }}</p>
                        </div>
                        <div>
                            <label class="block text-xs font-medium text-gray-500 dark:text-gray-400 uppercase mb-1">Phone</label>
                            <p class="text-gray-900 dark:text-white">{{ $tutor->contact_person_phone ?? '-' }}</p>
                        </div>
                    </div>
                </div>
            </div>
