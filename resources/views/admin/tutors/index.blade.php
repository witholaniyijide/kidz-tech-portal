<x-app-layout>
    <x-slot name="header">{{ __('Tutor Management') }}</x-slot>
    ...
    <div class="min-h-screen bg-gradient-to-br from-[#423A8E]/5 via-[#00CCCD]/5 to-blue-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 py-8 relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="flex flex-wrap items-center justify-between gap-4 mb-8">
                ...
                <a href="{{ route('admin.tutors.create') }}" class="inline-flex items-center px-5 py-3 bg-gradient-to-r from-[#423A8E] to-[#00CCCD] text-white font-medium rounded-xl hover:shadow-lg transform hover:-translate-y-0.5 transition-all">
            ...
            <div class="bg-white/60 dark:bg-gray-800/60 backdrop-blur-md border border-white/20 rounded-2xl shadow overflow-hidden">
                @if($tutors->isEmpty())
                    <div class="p-12 text-center">
                        ...
                        <a href="{{ route('admin.tutors.create') }}" class="inline-flex items-center px-5 py-2 bg-[#423A8E] text-white rounded-lg hover:bg-[#423A8E]">
                                    ...
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                                        <td class="px-6 py-4">
                                            <div class="flex items-center">
                                                ...
                                                @else
                                                    <div class="w-10 h-10 bg-gradient-to-br from-[#00CCCD] to-blue-500 rounded-full flex items-center justify-center text-white font-bold text-sm mr-3">
                                        ...
                                        <td class="px-6 py-4 text-right">
                                            <div class="flex items-center justify-end gap-2">
                                                <a href="{{ route('admin.tutors.show', $tutor) }}" class="p-2 text-gray-600 dark:text-gray-400 hover:text-[#423A8E] dark:hover:text-[#00CCCD] hover:bg-[#423A8E]/5 dark:hover:bg-[#423A8E]/40/20 rounded-lg transition-colors" title="View">
