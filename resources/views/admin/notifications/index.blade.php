        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="flex items-center justify-between mb-6">
                <div>
                    ...
                    <p class="text-gray-500 dark:text-gray-400 mt-1">Stay updated on system activities</p>
                </div>
                <div class="flex items-center space-x-4">
                    ...
                    @if($unreadCount > 0)
                        <form action="{{ route('admin.notifications.mark-all-read') }}" method="POST">
                            @csrf
                            <button type="submit" class="flex items-center space-x-2 px-4 py-2 text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-purple-600 dark:hover:text-purple-400 transition-colors">
            ...
            @if($notifications->count() > 0)
                <div class="space-y-4">
                    @foreach($notifications as $notification)
                        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-4 {{ !$notification->is_read ? 'border-l-4 border-l-purple-500' : '' }}">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <div class="flex items-center space-x-4 mt-3">
                                            @if(isset($notification->meta['link']))
                                                <a href="{{ $notification->meta['link'] }}" class="text-sm text-purple-600 dark:text-purple-400 hover:underline">
                                                    View Details
                                                </a>
                                            @endif
            ...
            @else
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm p-12 text-center">
                    ...
                    <p class="text-gray-500 dark:text-gray-400">
                        You'll receive notifications about system activities here.
                    </p>
                </div>
            @endif
        </div>
